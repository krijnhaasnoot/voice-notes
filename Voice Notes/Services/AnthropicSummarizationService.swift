...
actor AnthropicSummarizationService: SummarizationService {
        ...
        do {
            ...
            case 200:
                ...
                guard let content = json?["content"] as? [[String: Any]],
                      ...
                      let summary = firstContent["text"] as? String else {
                    throw SummarizationError.invalidResponse
                }
            ...
            default:
                if let errorData = try? JSONSerialization.jsonObject(with: data) as? [String: Any],
                   ...
                   let message = error["message"] as? String {
                    throw SummarizationError.networkError(NSError(domain: "Anthropic", code: httpResponse.statusCode, userInfo: [NSLocalizedDescriptionKey: message]))
                } else {
                    throw SummarizationError.invalidResponse
                }
            }
